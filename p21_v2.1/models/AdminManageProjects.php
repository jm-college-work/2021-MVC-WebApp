...
class AdminManageProjects extends Model{
...
//Initialise class members
    ...
    public function setPanelHead_1(){//set the panel 1 heading  
        switch ($this->pageID){
            case "manageProjects":
                $this->panelHead_1='<h3>Manage Projects</h3>';  
                break; 
            case "viewProjects":
                $this->panelHead_1='<h3>All Projects</h3>';  
                break;              
            case "deleteProject":
    ...
    public function setPanelContent_1(){//set the panel 1 content  
        switch ($this->pageID){
            case "manageProjects":   
                $this->panelContent_1="Welcome! From here, you can manage all user's projects.
                <br><img src=\"https://static.thenounproject.com/png/247210-200.png\">";
                break; 
            case "viewProjects":
                $projects = new ProjectTable($this->db);
                $this->panelContent_1 = HelperHTML::generateTABLE($projects->getAllRecords());
                break;            
            case "deleteProject":
    ...
    public function setPanelHead_2(){ //set the panel 2 heading  
        switch ($this->pageID){
            case "manageProjects":     
                ...
                break;             
            case "deleteProject":
                $this->panelHead_2='<h3>All Projects</h3>';  
                break;           
        }
    ...
    public function setPanelContent_2(){//set the panel 2 content     
        switch ($this->pageID){
            ...
            case "deleteProject":
                ...
                $this->panelContent_2 = HelperHTML::generateTABLE($projects->getAllRecords());
                break;
        }    
