...
//CLASS methods
	...
	function __construct($user,$pageTitle,$pageHead){   
            parent::__construct('CustomerHome',$user);
        ...
        public function setPanelContent_1(){//set the panel 1 content
            if($this->loggedin){ 
                if ($this->user->getUserType()==='CUSTOMER'){ //An ADMIN is logged in 
        ...
        public function setPanelContent_2(){//set the panel 2 content
            ...
            if($this->loggedin){
                ...
                if ($this->user->getUserType()==='CUSTOMER'){ //An ADMIN is logged in
                    $this->panelContent_2='Thank you <b>'.$this->user->getUserFirstName().' '.$this->user->getUserLastName() .'</b> for logging in successfully as a CUSTOMER to the P21 Web App. Please use the links above to manage your projects, messages and account. <br><br>Don\'t forget to logout when you are done.';
                }  
            }
            else{  //User is not logged in        
